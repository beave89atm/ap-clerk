...
def test_mcmaster_plus5_prefers_leftover_window_and_skips_first_five():
    ...
    assert LEAVE_ALONE_HOLD_IDS == {10140, 10142, 10143, 10146, 10148, 10154, 10158, 10159}
    ...
    assert DO_NOT_MUTATE_IDS == {10138, 10139, 10141, 10144, 10145, 10147, 10149, 10150, 10151, 10152, 10153, 10155, 10156, 10157}
