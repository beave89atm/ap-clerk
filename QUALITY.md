...
| **NOTE-56** Gas **0040443847** / KIMCO **10284** PDF unit 1.2076 stored as 1.21 (Kyle 2026-09-25) | Lines extended to $29.28 vs header verification $29.25. No PPV. Type 4 no-PO finish skipped PPV; the 9/24 recheck left Result Success. | When lines + charges ≠ header verification to the penny, post one signed PPV (lookup id 13) for the exact gap, including $0.01 / $0.02 / $0.03. Do not waive it as two-cent rounding. \|gap\| >= $75 is not penny PPV. 10284 → **−$0.03**. Success only after lines + charges equal the header. | `tests/test_penny_ppv.py` |
