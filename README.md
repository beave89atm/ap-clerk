...
3. **Receipt** — before HOLD-no-receipts, second pass: slip # = invoice #, part, qty, PO line, then open receipts on that PO **verified by invoice qty and merchandise cost**. Prefer exact qty (35 vs 36 → 35). Never first-open / `second-open-on-po` Success when multiple open receipts differ. Match part/PO-WO lines (Modern Heat), not first leftover qty. Regressions: Capital `26167`; Fastenal `TXFT499356`; Fastenal `TXFT4100079` / KIMCO **9968**.
