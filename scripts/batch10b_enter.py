...
Batch: API Agent - 9/25/26 Batch 10 #2.
...
BATCH_NAME = "API Agent - 9/25/26 Batch 10 #2"
OUT_JSON = ROOT / "artifacts" / "batch10b-2026-09-25.json"
CACHE = Path("/tmp/batch10")
PPV_LIMIT = ppv_limit()
TARGET_COUNT = 10

# Existing non-void live invoices. GET 2026-09-25. Used only to copy remit and terms.
# A1 18, Beshert 21, Eastern 9997, Morgan 5938, RMP 6085.
...
# Hand-checked against the vendor PDF. Feet on Eastern Metal are inches in KIMCO
# (54 ft = 648 in). Line unit prices are omitted so a per-foot or per-CWT price
# does not hide a Quantity_Received match. Statement packs are not in this list.
BILLS: list[dict[str, Any]] = [
    {
        ...
        "total": 550.64,
        "lines": [
            {"part": "Contract", "description": "A1 Platinum copier service contract", "qty": 1, "amount": 508.67},
        ],
        "fees": [],
        "tax": 41.97,
        "no_po_on_pdf": True,
    ...
    {
        "vendor": "Eastern Metal Supply of Texas",
        "invoice_number": "821669",
        "date": "2026-09-10",
        "due": "2026-10-10",
        "po": "59084",
        "total": 980.48,
        "lines": [
            {"part": "52-61-750", "description": "3 x 3 x 1/4 6061 square tube", "qty": 648},
        ],
        "fees": [{"name": "Shipping and handling surcharge", "amount": 60.00, "fee": True}],
    },
    {
        "vendor": "Eastern Metal Supply of Texas",
        "invoice_number": "821670",
        "date": "2026-09-10",
        "due": "2026-10-10",
        "po": "59095",
        "total": 693.98,
        "lines": [
            {"part": "19-61-140", "description": "1 inch square tube 1/8 wall", "qty": 1440},
            {"part": "15-61-225", "description": "1-1/2 inch 6061 square bar", "qty": 288},
        ],
        "fees": [],
        "clerk_note": (
            "AP Clerk: @Shawn McKibben Eastern Metal Supply of Texas invoice 821670 cannot be finished. "
            "The PDF total is $693.98. Amount entered on receipt lines is $0.00. PO 59095. "
            "The 1 inch square tube is 120 feet, which is 1,440 inches. Receipt 24032 Quantity_Received is 1,440 inches at $0.2354, which extends to $338.98. The invoice line for that tube is $338.88. "
            "The 1-1/2 inch square bar is 24 feet, which is 288 inches, for $355.10. There is no open receipt for that bar on PO 59095. "
            "Receipt 24033 is 288 inches of that bar at $1.233, which extends to $355.10, but it is on PO 59084, so it was not used. "
            "Work-order and outside-service lines on the open receipt were checked and the receipt does not carry a work order. "
            "No receipts were selected and no Purchase Price Variance was posted, because the bar line has no receipt on this purchase order and the dollar gap is $355.00, which is $75.00 or more. "
            "Shawn should receive the 1-1/2 inch bar on PO 59095 for the invoiced 288 inches. After that receipt exists, AP will select the receipts by Quantity_Received and finish the bill. "
            "The bill was moved to Transfer AP and is not posted."
        ),
    },
    {
        "vendor": "Beshert Steel Processing",
        "invoice_number": "JVT SI-44211",
        "date": "2026-09-09",
        "due": "2026-11-08",
        "po": "58975",
        "total": 5410.79,
        "lines": [
            {"part": "PL-0.313", "description": "Tempered leveled plate A572-GR50 pickled and oiled 0.3125 x 48 x 120", "qty": 13},
        ],
        "fees": [],
    },
    {
        "vendor": "Beshert Steel Processing",
        "invoice_number": "JVT SI-44212",
        "date": "2026-09-09",
        "due": "2026-11-08",
        "po": "58999",
        "total": 4481.10,
        "lines": [
            {"part": "YMPRESS", "description": "Temper passed plate YMPRESS 100 0.1875 x 60 x 120", "qty": 13},
        ],
        "fees": [],
    },
    {
        "vendor": "Beshert Steel Processing",
        "invoice_number": "JVT SI-44213",
        "date": "2026-09-09",
        "due": "2026-11-08",
        "po": "59029",
        "total": 11030.40,
        "lines": [
            {"part": "YMPRESS", "description": "Temper passed plate YMPRESS 100 0.2500 x 60 x 120", "qty": 24},
        ],
        "fees": [],
    },
    {
        "vendor": "Beshert Steel Processing",
        "invoice_number": "JVT SI-44214",
        "date": "2026-09-09",
        "due": "2026-11-08",
        "po": "59071",
        "total": 4067.46,
        "lines": [
            {"part": "A656", "description": "Temper passed plate A656-GR80 0.2500 x 60 x 120", "qty": 9},
        ],
        "fees": [],
    },
    {
        "vendor": "Morgan Steel",
        "invoice_number": "129501",
        "date": "2026-09-10",
        "due": "2026-10-25",
        "po": "58965",
        "total": 16898.00,
        "lines": [
            {"part": "FLPL18-L", "description": "Floor plate 1/8 laser", "qty": 60},
            {"part": "FLPL18-L", "description": "Floor plate 1/8 laser", "qty": 59},
        ],
        "fees": [],
    },
    {
        "vendor": "Morgan Steel",
        "invoice_number": "129511",
        "date": "2026-09-10",
        "due": "2026-10-25",
        "po": "58995",
        "total": 9060.00,
        ...
        "fees": [],
        "force_hold": "missing_receipt",
        "clerk_note": (
            "AP Clerk: @Shawn McKibben Morgan Steel invoice 129511 cannot be finished. "
            "The PDF total is $9,060.00. Amount entered on receipt lines is $0.00. PO 58995. "
            "The invoice is 60 pieces of floor plate at $151.00. "
            "Receipt 23950 shows Quantity_Received 60, receipt 24686 shows Quantity_Received -60, receipt 24687 shows Quantity_Received 60, and receipt 24688 shows Quantity_Received -60. "
            "Those four receipts net to Quantity_Received 0, so there is no open quantity to select. "
            "Work-order and outside-service lines were checked. Each of those receipts is work order 16467, SO34925.01.W000. "
            "This is a missing receipt, not a price variance. No receipts were selected and no Purchase Price Variance was posted. "
            "Shawn should receive the invoiced quantity of 60 on PO 58995. After that receipt exists, AP will select it by Quantity_Received and finish the bill. "
            "The bill was moved to Transfer AP and is not posted."
        ),
    },
    {
        "vendor": "RMP Industrial Supply Inc",
        "invoice_number": "1473030",
        "date": "2026-09-11",
        "due": "2026-10-11",
        "po": None,
        "total": 19.60,
        "lines": [
            {"part": "BRI 532202", "description": "M12 x 45 socket head cap screw", "qty": 50, "unit_price": 0.3919, "amount": 19.60},
        ],
        "fees": [],
        "no_po_on_pdf": True,
    },
...
def load_po_lines(client: Any, wanted: set[str]) -> list[dict[str, Any]]:
    ...
    while total is None or offset < total:
        ...
        for item in items:
            ...
            po_text = lookup_text(po_lookup) or ""
            po = ""
            for candidate in wanted:
                if candidate and candidate in po_text:
                    po = candidate
                    break
            if not po:
                continue
...
def load_receipts(client: Any, wanted: set[str]) -> list[dict[str, Any]]:
    ...
    for rid in ids:
        ...
        if values.get("Invoiced") is True or ap_text:
            continue
        received = values.get("Quantity_Received")
        received_qty = money(received)
        # An unreceive (negative Quantity_Received) is not a receipt to select.
        if received_qty in (None, 0, 0.0) or (received_qty is not None and received_qty < 0):
            continue
        wo = values.get("Work_Order_Issue") or values.get("Work_Order")
        normalized["po"] = str(po or "")
        normalized["qty_received"] = received_qty
        normalized["qty"] = normalized["qty_received"]
        raw_unit = values.get("PO_Item_Number_$_Unit_Price")
        try:
            unit = round(float(raw_unit), 4) if raw_unit not in (None, "") else None
        except (TypeError, ValueError):
            unit = None
        normalized["unit"] = unit if unit is not None else normalized.get("unit_price")
...
def _raw_price(row: dict[str, Any]) -> float | None:
    """Keep the receipt unit price past two decimals. 1.4205 must not become 1.42."""
    raw = row.get("unit_price") if row.get("unit_price") is not None else row.get("unit")
    if raw in (None, ""):
        return None
    try:
        return float(raw)
...
def plan_bill(bill: dict[str, Any], po_lines: list[dict[str, Any]], receipts: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    if bill.get("force_hold") == "missing_receipt":
...
def write_comment(client: Any, kimco_id: int, text: str, *, mention: bool) -> dict[str, Any]:
    ...
    existing = client.get_item("ap_invoices", kimco_id)
    for comment in (existing.get("lists") or {}).get("Comments_1") or []:
        html_live = html.unescape(str((comment.get("values") or {}).get("HtmlValue") or ""))
        tagged = 'data-mention-id="104"' in html_live
        if needle[:24] and needle[:24] in html_live and (tagged or not mention):
            return {"status": "persisted", "id": comment.get("id"), "mention": tagged, "error": ""}
    note_html = html_for_note(text, mention=mention)
    payload = {
        "state": "Modified",
        "id": int(kimco_id),
        "lists": {
...
def snapshot(client: Any, kimco_id: int) -> dict[str, Any]:
    ...
    for line in lists.get("APInvoiceLine") or []:
        ...
        raw_unit = lv.get("Unit_Price")
        try:
            unit_price = round(float(raw_unit), 4) if raw_unit not in (None, "") else None
        except (TypeError, ValueError):
            unit_price = money(raw_unit)
        receipt_rows.append(
            {
...
def enter(*, write: bool) -> dict[str, Any]:
    ...
    for bill in BILLS:
        ...
        resume_id = None
        if hit and str(hit.get("batch") or "") == BATCH_NAME and not hit.get("posted"):
            resume_id = int(hit["id"])
            print(f"RESUME {bill['invoice_number']} {resume_id}", flush=True)
        elif hit:
    ...
    for plan in plans:
        ...
        if plan.get("resume_id"):
            created_id, status, error = int(plan["resume_id"]), 200, ""
        else:
