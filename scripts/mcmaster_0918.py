...
LEAVE_ALONE_HOLD_IDS = {10140, 10142, 10143, 10146, 10148, 10152, 10154, 10158, 10159}
# Finished Successes. GET-only — do not re-Select / edit.
DO_NOT_MUTATE_IDS = {10138, 10139, 10141, 10144, 10145, 10147, 10149, 10150, 10151, 10153, 10155, 10156, 10157}
