"""Enter 5 more AQPC payment-request bills on batch 711 (35-row sheet).

Skips KIMCO 10007–10036 and Kyle-entered 10917/10918/10920/10921.
...
LOGGER = logging.getLogger("ap_clerk.aqpc_batch711_35")
...
PRIOR_SHEET = ROOT / "runs" / "AP-run-2026-09-15-aqpc-batch711-30.json"
HOLD_PDF_AMOUNTS = {
    10009: 10.0,
    10013: 199.0,
    10021: 700.0,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Enter 5 more AQPC invoices on batch 711 (35-row sheet)")
    parser.add_argument("--discover-only", action="store_true")
    parser.add_argument("--skip-enter", action="store_true")
    parser.add_argument(
        "--report",
        default=str(ROOT / "runs" / "AP-run-2026-09-15-aqpc-batch711-35.xlsx"),
    )
    ...
    print(f"ALL 35: Success={all_success} HOLD={all_hold}", flush=True)
    return 0
